...
impl EvalParamSpec {
    pub const fn new(
        ...
        Self { name, default, min, max, step, weight, description }
    }
...
pub const TUNABLE_EVAL_PARAM_SPECS: &[EvalParamSpec] = &[
    EvalParamSpec::new("knight", crate::evaluation::base::DEFAULT_EVAL_KNIGHT as i64, 150, 450, 4, 0.9, "Knight value"),
    EvalParamSpec::new("bishop", crate::evaluation::base::DEFAULT_EVAL_BISHOP as i64, 250, 650, 4, 0.9, "Bishop value"),
    EvalParamSpec::new("rook", crate::evaluation::base::DEFAULT_EVAL_ROOK as i64, 450, 850, 6, 0.9, "Rook value"),
    EvalParamSpec::new("guard", crate::evaluation::base::DEFAULT_EVAL_GUARD as i64, 120, 420, 4, 0.6, "Guard value"),
    EvalParamSpec::new("centaur", crate::evaluation::base::DEFAULT_EVAL_CENTAUR as i64, 350, 750, 6, 0.7, "Centaur value"),
    EvalParamSpec::new("compound_bonus", crate::evaluation::base::DEFAULT_EVAL_COMPOUND_BONUS as i64, 0, 250, 4, 0.5, "Compound piece bonus"),
    EvalParamSpec::new("camel", crate::evaluation::base::DEFAULT_EVAL_CAMEL as i64, 120, 470, 4, 0.6, "Camel value"),
    EvalParamSpec::new("giraffe", crate::evaluation::base::DEFAULT_EVAL_GIRAFFE as i64, 120, 460, 4, 0.6, "Giraffe value"),
    EvalParamSpec::new("zebra", crate::evaluation::base::DEFAULT_EVAL_ZEBRA as i64, 120, 460, 4, 0.6, "Zebra value"),
    EvalParamSpec::new("knightrider", crate::evaluation::base::DEFAULT_EVAL_KNIGHTRIDER as i64, 500, 900, 8, 0.7, "Knightrider value"),
    EvalParamSpec::new("hawk", crate::evaluation::base::DEFAULT_EVAL_HAWK as i64, 400, 800, 6, 0.7, "Hawk value"),
    EvalParamSpec::new("archbishop", crate::evaluation::base::DEFAULT_EVAL_ARCHBISHOP as i64, 700, 1100, 8, 0.7, "Archbishop value"),
    EvalParamSpec::new("rose", crate::evaluation::base::DEFAULT_EVAL_ROSE as i64, 250, 650, 6, 0.6, "Rose value"),
    EvalParamSpec::new("huygen", crate::evaluation::base::DEFAULT_EVAL_HUYGEN as i64, 155, 555, 4, 0.6, "Huygen value"),
    EvalParamSpec::new("chancellor_bonus", crate::evaluation::base::DEFAULT_EVAL_CHANCELLOR_BONUS as i64, 0, 300, 4, 0.5, "Chancellor extra value bonus"),
    EvalParamSpec::new("mg_doubled_pawn_penalty", crate::evaluation::base::DEFAULT_EVAL_MG_DOUBLED_PAWN_PENALTY as i64, 0, 208, 2, 0.5, "Middlegame doubled pawn penalty"),
    EvalParamSpec::new("eg_doubled_pawn_penalty", crate::evaluation::base::DEFAULT_EVAL_EG_DOUBLED_PAWN_PENALTY as i64, 0, 212, 2, 0.5, "Endgame doubled pawn penalty"),
    EvalParamSpec::new("mg_bishop_pair_bonus", crate::evaluation::base::DEFAULT_EVAL_MG_BISHOP_PAIR_BONUS as i64, 0, 260, 2, 0.6, "Middlegame bishop pair bonus"),
    EvalParamSpec::new("eg_bishop_pair_bonus", crate::evaluation::base::DEFAULT_EVAL_EG_BISHOP_PAIR_BONUS as i64, 0, 280, 2, 0.6, "Endgame bishop pair bonus"),
    EvalParamSpec::new("rook_open_file_bonus", crate::evaluation::base::DEFAULT_EVAL_ROOK_OPEN_FILE_BONUS as i64, 0, 245, 2, 0.5, "Rook open file bonus"),
    EvalParamSpec::new("rook_semi_open_file_bonus", crate::evaluation::base::DEFAULT_EVAL_ROOK_SEMI_OPEN_FILE_BONUS as i64, 0, 220, 2, 0.5, "Rook semi-open file bonus"),
    EvalParamSpec::new("queen_open_file_bonus", crate::evaluation::base::DEFAULT_EVAL_QUEEN_OPEN_FILE_BONUS as i64, 0, 225, 2, 0.4, "Queen open file bonus"),
    EvalParamSpec::new("queen_semi_open_file_bonus", crate::evaluation::base::DEFAULT_EVAL_QUEEN_SEMI_OPEN_FILE_BONUS as i64, 0, 210, 2, 0.4, "Queen semi-open file bonus"),
    EvalParamSpec::new("mg_outpost_bonus", crate::evaluation::base::DEFAULT_EVAL_MG_OUTPOST_BONUS as i64, 0, 220, 2, 0.5, "Middlegame outpost bonus"),
    EvalParamSpec::new("eg_outpost_bonus", crate::evaluation::base::DEFAULT_EVAL_EG_OUTPOST_BONUS as i64, 0, 250, 2, 0.5, "Endgame outpost bonus"),
];
...
pub const TUNABLE_PARAM_SPECS: &[SearchParamSpec] = &[
    SearchParamSpec::new("razoring_linear", SearchParamKind::I32, DEFAULT_RAZORING_LINEAR as i64, 200, 700, 16, 0.7, "Razoring linear margin"),
    SearchParamSpec::new("razoring_quad", SearchParamKind::I32, DEFAULT_RAZORING_QUAD as i64, 100, 500, 12, 0.7, "Razoring quadratic margin"),
    SearchParamSpec::new("nmp_min_depth", SearchParamKind::Usize, DEFAULT_NMP_MIN_DEPTH as i64, 1, 8, 1, 0.8, "Null move minimum depth"),
    SearchParamSpec::new("nmp_base", SearchParamKind::I32, DEFAULT_NMP_BASE as i64, 100, 600, 16, 0.9, "Null move base margin"),
    SearchParamSpec::new("nmp_depth_mult", SearchParamKind::I32, DEFAULT_NMP_DEPTH_MULT as i64, 8, 48, 2, 0.8, "Null move depth multiplier"),
    SearchParamSpec::new("nmp_reduction_base", SearchParamKind::Usize, DEFAULT_NMP_REDUCTION_BASE as i64, 2, 12, 1, 0.8, "Null move reduction numerator"),
    SearchParamSpec::new("nmp_reduction_div", SearchParamKind::Usize, DEFAULT_NMP_REDUCTION_DIV as i64, 1, 8, 1, 0.8, "Null move reduction divisor"),
    SearchParamSpec::new("lmr_min_depth", SearchParamKind::Usize, DEFAULT_LMR_MIN_DEPTH as i64, 1, 8, 1, 0.9, "Late move reduction minimum depth"),
    SearchParamSpec::new("lmr_min_moves", SearchParamKind::Usize, DEFAULT_LMR_MIN_MOVES as i64, 1, 16, 1, 0.8, "Late move reduction minimum move count"),
    SearchParamSpec::new("lmr_divisor", SearchParamKind::Usize, DEFAULT_LMR_DIVISOR as i64, 1, 8, 1, 0.8, "Late move reduction divisor"),
    SearchParamSpec::new("lmr_cutoff_thresh", SearchParamKind::U8, DEFAULT_LMR_CUTOFF_THRESH as i64, 1, 8, 1, 0.5, "Late move reduction cutoff threshold"),
    SearchParamSpec::new("lmr_tt_history_thresh", SearchParamKind::I32, DEFAULT_LMR_TT_HISTORY_THRESH as i64, -4000, 0, 64, 0.6, "Late move reduction TT history threshold"),
    SearchParamSpec::new("hlp_max_depth", SearchParamKind::Usize, DEFAULT_HLP_MAX_DEPTH as i64, 1, 8, 1, 0.6, "History leaf pruning maximum depth"),
    SearchParamSpec::new("hlp_min_moves", SearchParamKind::Usize, DEFAULT_HLP_MIN_MOVES as i64, 1, 16, 1, 0.6, "History leaf pruning minimum move count"),
    SearchParamSpec::new("hlp_history_reduce", SearchParamKind::I32, DEFAULT_HLP_HISTORY_REDUCE as i64, -2000, 2000, 64, 0.6, "History threshold for extra late-move reduction"),
    SearchParamSpec::new("hlp_history_leaf", SearchParamKind::I32, DEFAULT_HLP_HISTORY_LEAF as i64, -2000, 2000, 64, 0.6, "History threshold for pruning leaf moves"),
    SearchParamSpec::new("lmp_base", SearchParamKind::Usize, DEFAULT_LMP_BASE as i64, 1, 12, 1, 0.7, "Late move pruning base"),
    SearchParamSpec::new("lmp_depth_mult", SearchParamKind::Usize, DEFAULT_LMP_DEPTH_MULT as i64, 0, 6, 1, 0.7, "Late move pruning depth multiplier"),
    SearchParamSpec::new("aspiration_window", SearchParamKind::I32, DEFAULT_ASPIRATION_WINDOW as i64, 8, 256, 8, 0.7, "Initial aspiration window"),
    SearchParamSpec::new("aspiration_fail_mult", SearchParamKind::I32, DEFAULT_ASPIRATION_FAIL_MULT as i64, 2, 8, 1, 0.5, "Aspiration fail expansion multiplier"),
    SearchParamSpec::new("aspiration_max_window", SearchParamKind::I32, DEFAULT_ASPIRATION_MAX_WINDOW as i64, 256, 4000, 64, 0.4, "Maximum aspiration window"),
    SearchParamSpec::new("rfp_max_depth", SearchParamKind::Usize, DEFAULT_RFP_MAX_DEPTH as i64, 1, 20, 1, 0.7, "Reverse futility maximum depth"),
    SearchParamSpec::new("rfp_mult_tt", SearchParamKind::I32, DEFAULT_RFP_MULT_TT as i64, 1, 256, 4, 0.8, "Reverse futility TT multiplier"),
    SearchParamSpec::new("rfp_mult_no_tt", SearchParamKind::I32, DEFAULT_RFP_MULT_NO_TT as i64, 1, 256, 4, 0.8, "Reverse futility non-TT multiplier"),
    SearchParamSpec::new("rfp_improving_mult", SearchParamKind::I32, DEFAULT_RFP_IMPROVING_MULT as i64, 256, 4096, 64, 0.6, "Reverse futility improving multiplier"),
    SearchParamSpec::new("rfp_worsening_mult", SearchParamKind::I32, DEFAULT_RFP_WORSENING_MULT as i64, 0, 2048, 32, 0.6, "Reverse futility worsening multiplier"),
    SearchParamSpec::new("probcut_margin", SearchParamKind::I32, DEFAULT_PROBCUT_MARGIN as i64, 0, 512, 8, 0.7, "ProbCut margin"),
    SearchParamSpec::new("probcut_improving", SearchParamKind::I32, DEFAULT_PROBCUT_IMPROVING as i64, 0, 256, 4, 0.6, "ProbCut improving adjustment"),
    SearchParamSpec::new("probcut_min_depth", SearchParamKind::Usize, DEFAULT_PROBCUT_MIN_DEPTH as i64, 1, 12, 1, 0.7, "ProbCut minimum depth"),
    SearchParamSpec::new("probcut_depth_sub", SearchParamKind::Usize, DEFAULT_PROBCUT_DEPTH_SUB as i64, 1, 8, 1, 0.7, "ProbCut depth subtraction"),
    SearchParamSpec::new("probcut_divisor", SearchParamKind::I32, DEFAULT_PROBCUT_DIVISOR as i64, 32, 1024, 16, 0.6, "ProbCut static-eval divisor"),
    SearchParamSpec::new("low_depth_probcut_margin", SearchParamKind::I32, DEFAULT_LOW_DEPTH_PROBCUT_MARGIN as i64, 128, 2048, 32, 0.6, "Low-depth ProbCut margin"),
    SearchParamSpec::new("iir_min_depth", SearchParamKind::Usize, DEFAULT_IIR_MIN_DEPTH as i64, 1, 12, 1, 0.5, "Internal iterative reduction minimum depth"),
    SearchParamSpec::new("see_capture_linear", SearchParamKind::I32, DEFAULT_SEE_CAPTURE_LINEAR as i64, 0, 512, 8, 0.7, "SEE capture pruning linear term"),
    SearchParamSpec::new("see_capture_hist_div", SearchParamKind::I32, DEFAULT_SEE_CAPTURE_HIST_DIV as i64, 1, 128, 2, 0.6, "SEE capture history divisor"),
    SearchParamSpec::new("see_quiet_quad", SearchParamKind::I32, DEFAULT_SEE_QUIET_QUAD as i64, 1, 128, 2, 0.7, "SEE quiet pruning quadratic term"),
    SearchParamSpec::new("see_winning_threshold", SearchParamKind::I32, DEFAULT_SEE_WINNING_THRESHOLD as i64, -256, 256, 8, 0.5, "SEE threshold for classifying winning captures"),
    SearchParamSpec::new("sort_hash", SearchParamKind::I32, DEFAULT_SORT_HASH as i64, 1_000_000, 10_000_000, 100_000, 0.3, "Hash move ordering bonus"),
    SearchParamSpec::new("sort_winning_capture", SearchParamKind::I32, DEFAULT_SORT_WINNING_CAPTURE as i64, 100_000, 4_000_000, 50_000, 0.4, "Winning capture ordering bonus"),
    SearchParamSpec::new("sort_killer1", SearchParamKind::I32, DEFAULT_SORT_KILLER1 as i64, 100_000, 4_000_000, 50_000, 0.4, "Primary killer ordering bonus"),
    SearchParamSpec::new("sort_killer2", SearchParamKind::I32, DEFAULT_SORT_KILLER2 as i64, 100_000, 4_000_000, 50_000, 0.4, "Secondary killer ordering bonus"),
    SearchParamSpec::new("sort_countermove", SearchParamKind::I32, DEFAULT_SORT_COUNTERMOVE as i64, 100_000, 4_000_000, 50_000, 0.4, "Countermove ordering bonus"),
    SearchParamSpec::new("history_bonus_base", SearchParamKind::I32, DEFAULT_HISTORY_BONUS_BASE as i64, 0, 1024, 16, 0.6, "History bonus base"),
    SearchParamSpec::new("history_bonus_sub", SearchParamKind::I32, DEFAULT_HISTORY_BONUS_SUB as i64, 0, 1024, 16, 0.6, "History bonus subtraction"),
    SearchParamSpec::new("history_bonus_cap", SearchParamKind::I32, DEFAULT_HISTORY_BONUS_CAP as i64, 64, 8192, 64, 0.6, "History bonus cap"),
    SearchParamSpec::new("history_max_gravity", SearchParamKind::I32, DEFAULT_HISTORY_MAX_GRAVITY as i64, 1024, 32768, 256, 0.4, "History gravity clamp"),
    SearchParamSpec::new("pawn_history_bonus_scale", SearchParamKind::I32, DEFAULT_PAWN_HISTORY_BONUS_SCALE as i64, 0, 8, 1, 0.5, "Pawn history bonus scale"),
    SearchParamSpec::new("pawn_history_malus_scale", SearchParamKind::I32, DEFAULT_PAWN_HISTORY_MALUS_SCALE as i64, 0, 8, 1, 0.5, "Pawn history malus scale"),
    SearchParamSpec::new("delta_margin", SearchParamKind::I32, DEFAULT_DELTA_MARGIN as i64, 0, 512, 8, 0.6, "Quiescence delta pruning margin"),
];
